...
final class P11LargestProductInAGridTest {
  ...
  @Test
  void test4x4Grid2Adjacent() {
    assertThat(largestProductInAGrid.apply(ARRAY_4X4, 2)).isEqualTo(240L);
  }

  @Test
  void test20x20Grid4Adjacent() {
    assertThat(largestProductInAGrid.apply(ARRAY_20X20, 4)).isEqualTo(70_600_674L);
  }
}

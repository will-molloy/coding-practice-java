 ...
 * lazy quantification.
 *
 * <p>TODO refactor all these problems (the {@link wilmol.hackerrank.regex.applications} ones) to
 * use a single regex? Kinda cheating to use multiple regex.
 *
 * @see wilmol.hackerrank.regex.applications.easy.DetectHtmlAttributes
 * @see wilmol.hackerrank.regex.applications.easy.DetectHtmlTags
 */

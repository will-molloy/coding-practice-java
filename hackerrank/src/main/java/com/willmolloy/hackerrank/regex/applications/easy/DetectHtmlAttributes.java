 ...
 * <p>Runtime: O(n)
 *
 * <p>Key idea: capturing groups to extract entire opening tag, then capturing group to extract
 * attributes using {@code find()}.
 *
 * @see DetectHtmlTags
 * @see com.willmolloy.hackerrank.regex.applications.medium.DetectHtmlLinks

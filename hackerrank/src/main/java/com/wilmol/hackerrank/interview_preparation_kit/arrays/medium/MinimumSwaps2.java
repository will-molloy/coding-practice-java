 ...
 * <p>
 * Minimum swaps to sort the array (array has heavy constraints)
 * <p>
 * Runtime: O(n)
 */
class MinimumSwaps2
{
  ...
  // given the elements (e1, ..., en) fit 1 <= e <= n and no duplicates, the sorted array will be [1, 2, 3, ..., n]
  static int minimumSwaps(int[] a)
  {
    boolean[] visited = new boolean[a.length];
    int numSwaps = 0;
    // the unsorted elements form cycles
    // min number of swaps to fix a cycle the length of the cycle -1 (-1 since last swap fixes two elements)

 ...
 * <p>
 * Given two lists which have a common suffix, contains the merge point.
 * <p>
 * Runtime: O(n)
 */
class FindMergePointOfTwoLists
{
  ...
  // Given they have a common suffix, if we concat the two lists (both ways), they must meet the convergence after the
  ...
  // I.e. the trivial case (where both lists are the same size, and therefore equal (due to common suffix)) is being

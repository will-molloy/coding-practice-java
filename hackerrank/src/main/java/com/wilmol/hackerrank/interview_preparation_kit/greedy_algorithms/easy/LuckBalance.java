 ...
 * <p>
 * Would have preferred to 'win' as many contests as possible, why would you want to lose?
 * <p>
 * Runtime: O(n log k) with O(k) extra space
 */
class LuckBalance
{

  // want to lose as many contests as possible (to maximise the luck balance)
  // options: sort the array descending and take first k elements or keep track of top 'k' elements via min heap

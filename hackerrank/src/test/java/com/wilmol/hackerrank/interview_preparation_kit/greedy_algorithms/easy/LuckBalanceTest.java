...
import static com.wilmol.hackerrank.interview_preparation_kit.greedy_algorithms.easy.LuckBalance.luckBalance;
...
class LuckBalanceTest
{
  ...
  {
    // 5 + 2 - 1 + 8 + 10 + 5
    assertThat(luckBalance(3, new int[][]{ { 5, 1 }, { 2, 1 }, { 1, 1 }, { 8, 1 }, { 10, 0 }, { 5, 0 } })).isEqualTo(29);
  }
  ...
  {
    // 5 - 2 - 1 + 8 + 10 + 5
    assertThat(luckBalance(2, new int[][]{ { 5, 1 }, { 2, 1 }, { 1, 1 }, { 8, 1 }, { 10, 0 }, { 5, 0 } })).isEqualTo(25);
  }
  ...
  {
    // - 5 - 2 - 1 - 8 + 10 + 5
    assertThat(luckBalance(0, new int[][]{ { 5, 1 }, { 2, 1 }, { 1, 1 }, { 8, 1 }, { 10, 0 }, { 5, 0 } })).isEqualTo(-1);
  }

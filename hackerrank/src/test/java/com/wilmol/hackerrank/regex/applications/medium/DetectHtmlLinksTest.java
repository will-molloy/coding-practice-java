...
import static com.wilmol.hackerrank.regex.applications.medium.DetectHtmlLinks.detectLinks;
...
class DetectHtmlLinksTest {
  ...
  @Test
  void sampleInput2MultipleAttributesInATag() {
  ...
  @Test
  void testCase3CanHaveEmptyTitleAndShouldIgnoreOtherHrefAttributes() {
    // title can be empty
    assertThat(
            detectLinks(
                ImmutableList.of(
                    ...
                    "</div>",
                    "</center>")))
        .containsExactly("/wiki/File:Female_and_male_Pardalotus_punctatus.jpg,")
        .inOrder();
  }

  @Test
  void testCase5() {
    // this one caused issues with greedy matching

 ...
 */
final class P173BinarySearchTreeIteratorTest {

  @Test
  void example() {
    BstIterator iterator = new BstIterator(TreeNode.fromLevelOrder(7, 3, 15, null, null, 9, 20));
  ...
  @Test
  void completeTree() {
    BstIterator iterator = new BstIterator(TreeNode.fromLevelOrder(4, 2, 6, 1, 3, 5, 7));
    assertThat(iterator.hasNext()).isTrue();

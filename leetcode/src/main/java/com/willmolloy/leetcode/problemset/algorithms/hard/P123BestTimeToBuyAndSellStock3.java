 ...
 */
sealed interface P123BestTimeToBuyAndSellStock3 {
   ...
   * <p>Space: O(1)
   */
  final class BruteForce implements P123BestTimeToBuyAndSellStock3 {
   ...
   * <p>Space: O(1)
   */
  final class Linear implements P123BestTimeToBuyAndSellStock3 {
